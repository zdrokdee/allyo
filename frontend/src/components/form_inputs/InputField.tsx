import { FC, TextareaHTMLAttributes, InputHTMLAttributes, useRef, useEffect } from "react";
  ...
  // Auto-grow textarea height
    ...
    const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
        ...
        <div className="flex justify-between sub13-reg text-neutral-10">
            ...
            {maxLength && (
                <span
                    className={`sub10-reg pt-0.5 ${
                    (value?.toString().length || 0) >= maxLength ? 'text-tech-attention' : 'text-neutral-10'
                    }`}
                >
